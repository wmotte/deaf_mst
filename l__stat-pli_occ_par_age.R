...
outdir <- 'stats_pli_nigeria__occ_par_age'
...
write.csv( fc, file = paste0( outdir, '/pli-parietal-occipital.csv' ) )
...
# write output
write.csv( res, file = paste0( outdir, '/group_differences_in_occ-par_pli-FC_age__bayes-factors.csv' ) )
